...
@Component({
  selector: 'app-project-receipt',
  templateUrl: './project-receipt.component.html',
  styleUrls: ['./project-receipt.component.scss']
})
export class ProjectReceiptComponent implements OnInit {
  getRight: any;
  RightObj: {};
